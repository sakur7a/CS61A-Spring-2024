...
def boar_brawl(player_score, opponent_score):
    ...
    opponent_num=0
    if opponent_score>=10: opponent_num=opponent_score//10%10
    return max(1,abs(player_num-opponent_num)*3)
    # END PROBLEM 2
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    of the current player after they take t
    strategy0: The strategy for player0.
    strategy1: The strategy for player1.
    update:    The update function (used for both players).
    score0:    Starting score for Player 0heir turn.
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(goal+1):
        for opponent_score in range(goal+1):
            if strategy(score,opponent_score)!=first_result: return False
    return True
    # END PROBLEM 7
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    boar_num=abs(score%10-opponent_score//10%10)*3
    if boar_num>=threshold: return 0
    return num_rolls
    # END PROBLEM 10
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    boar_num=max(abs(score%10-opponent_score//10%10)*3,1)
    if (sus_points(boar_num+score)-score)>=threshold: return 0
    return num_rolls
    # END PROBLEM 11
