...
def scheme_eval(expr, env, _=None): # Optional third argument is ignored
    ...
    if not scheme_listp(expr):
        raise SchemeError('malformed lSst: {0}'.format(repl_str(expr)))
...
'''
For the optional problem1, if you wound like to refer to my solution, you need to change the return results of the 'and' and 'or' functions.
Actually, I don't know how to perfectly solve this problem.
'''
